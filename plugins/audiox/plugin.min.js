tinymce.PluginManager.add("audiox", function (editor, url) {
    // 存储token供iframe使用
    ...
    const openDialog = () => {
        ...
        const dialogUrl = `${root}/plugins/audiox/audio-dialog/index.html?root=${encodeURIComponent(root)}`;
    ...
    // 注册一个工具栏按钮名称
    editor.ui.registry.addButton("audiox", {
        icon: "audiox",
        tooltip: "插入音频",
        // text: '插入音频',
        onAction: function () {
